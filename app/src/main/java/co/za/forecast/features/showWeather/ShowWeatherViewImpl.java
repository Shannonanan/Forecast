...
public class ShowWeatherViewImpl extends BaseViewMvc<ShowWeatherContract.Listener>
    ...
    public void renderCurrentWeather(CurrentWeather currentWeather) {
        ...
        String maintemp = TemperatureConverter.getInstance().convertKelvinToCelsius(currentWeather.getMain().getTemp());
        String minTemp = TemperatureConverter.getInstance().convertKelvinToCelsius(currentWeather.getMain().getTempMin());
        String maxTemp = TemperatureConverter.getInstance().convertKelvinToCelsius(currentWeather.getMain().getTempMax());
